...
if not teacher:
    ...
    teacher = 'codebert' # avoid KeyError
...
DISTILLED_MODEL = f"model/distilled-{task}-{teacher}-{args.student}-{args.tokenizer}-{args.lr}-{args.beta}-{args.gamma}-{args.temp}" \
...
BETA, GAMMA, TEMP = args.beta, args.gamma, args.temp
